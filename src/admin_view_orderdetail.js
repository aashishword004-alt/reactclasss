    ...
    <div className="col-12">
      <div className="card shadow mb-4">
        <div className="card-header py-3 d-flex justify-content-between">
          ...
          <span>
            <a href="admin_orders.html" className="btn btn-primary btn-sm me-2">
              Back
            </a>
            <a href="admin_print_order.html" className="btn btn-primary btn-sm">
              Print
            </a>
          </span>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colSpan={3}>
                  ...
                  possimus maxime debitis! Atque doloribus laborum similique
                  officia deleniti delectus velit, et consequatur provident
                  quas, ex sequi necessitatibus a tenetur? Culpa.
                </td>
              </tr>
            </tbody>
          </table>
